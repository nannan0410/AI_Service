...
| 推荐产品 | 单条消息：文案 + TicketCard（2大0小=成人票×张数，2大1小=家庭套票，3大1小=成人+儿童购物车） |
...
| 9b | 附近项目 | demo_vip（在园） | 游游推荐「附近有什么好玩的」→ 相对距离 + 在园关怀 + `scene_recommend(nearby)` |
...
| 了解总目标、已拍板决策、架构与分期意图 | [落地计划](./docs/AI景区智能聊天助手-落地计划.md)（**进度勾选以项目现状为准**） |

# 景区 AI 智能聊天助手（演示版 v0.2.0）

基于 Vue 3 + Vant 4 + 硅基流动（OpenAI 兼容）+ vite-plugin-mock 的移动端演示项目。

**版本说明**：[docs/版本变动说明-v0.2.0.md](./docs/版本变动说明-v0.2.0.md)
...
| 7 | 批量开发票 | demo_vip | 欢迎「批量开发票」→ 勾选 2 笔 → 提交 |
| 7b | 对话开票 | demo_vip | 「我要开发票」→ PageGuideCard → 开票页 |
...
- **RecommendEntry API**：**快捷服务**规则入口（交通指南、查看订单、**批量开发票** 等，最多 4 个）
